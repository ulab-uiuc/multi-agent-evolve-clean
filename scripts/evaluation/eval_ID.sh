...
python -m absolute_zero_reasoner.main_azr_ppo \
    ...
    +benchmark_names="['mmlu', 'math', 'gsm8k', 'arc_challenge', 'gpqa', 'commonsenseqa', 'openbookqa', 'naturalquestions', 'triviaqa', 'squad', 'boolq', 'hellaswag']" \
    ...
    trainer.experiment_name='MAE_3B_halfref_eval_ID' \
